      ...
      <div className="border border-ink-100 p-2">
        ...
        <div className="space-y-px">
          <div className="flex items-baseline gap-2">
            <span className="w-4 text-3xs text-ink-200 text-right shrink-0">0</span>
            <span className="text-3xs tracking-wider font-medium break-all">
          ...
          {hashCascade.map((hash, i) => {
            ...
            return (
              <div key={i} className="flex items-baseline gap-2">
                <span className="w-4 text-3xs text-ink-200 text-right shrink-0">
                  {i + 1}
                </span>
                <span
                  className="text-3xs tracking-wider break-all"
                  style={{ opacity }}
                >
